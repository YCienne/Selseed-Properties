...
import { playImg, pauseImg, replayImg } from "../assets";
...
const VideoCarousel = () => {
    ...
    if (span[videoId]) {
      ...
      // update the progress bar
        ...
        videoRef.current[videoId].currentTime /
            house_details[videoId].videoDuration
        );
        };
  ...
  // vd id is the id for every video until id becomes number 3
    ...
    <>
        ...
        {house_details.map((list, i) => (
            <div key={list.id} id="slider" className="sm:pr-10 pr-10">
            <div className="video-carousel_container">
                ...
                {list.textList.map((text, i) => (
                    <p key={i} className="md:text-2xl text-xl font-small">
                    {text}
                    </p>
                ))}
                </div>
