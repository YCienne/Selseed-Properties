    ...
    <Section crosses>
        <div className="container lg:flex">
            ...
            <div className="lg:ml-auto xl:w-[38rem] mt-4">
                <p className="body-2 mb-10 text-n-4 d:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto">
                    {collabText}
                </p>
                <div className="mt-2 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
