            ...
            <div className="relative">
                ...
                border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                    ...
                    <div className="relative z-1 max-w-[17rem] ml-auto">
                        <h4 className="h4 mb-4">SSAI</h4>
                        <p className="body-2 mb-[3rem] text-n-3">It unlocks the power of potential ai</p>
                        <ul className="body-2">
                ...
                <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                    ...
                    <div className="absolute inset-0">
                        <img src={service2} className="h-full w-full object-cover" width={630} height={750} alt="Lang" />
                    </div>
